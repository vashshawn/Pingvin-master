...
class P2PPolicyTests(BitcoinTestFramework):
    ...
    def setup_network(self):
        ...
        # a Pingvin Core node that behaves similar to mainnet policies
    ...
    def run_test(self):
        ...
        # create a bunch of UTXO with seed money from the Pingvin Core wallet
        for i in range(10):
    ...
    # spend seed money with a key not in the Pingvin Core wallet.
    def spend_utxo(self, output):
        # construct the transaction using Pingvin Core raw tx APIs
        ...
        # and send the tx from there rather than from Pingvin Core, to test
