Pingvin Core version 1.14.5 is now available from:

  <https://github.com/pingvin/pingvin/releases/tag/v1.14.5/>

This is a new minor version release, including important security updates and
changes to network policies. All Pingvin Core users, miners, services, relay
...
To receive security and update notifications, please watch reddit or Twitter:
  ...
  * https://www.reddit.com/r/pingvindev/
...
Pingvin Core is extensively tested on Ubuntu Server LTS, Intel-based macOS
and Windows 10.
...
most Pingvin Core users.

### Remote Code Execution in Pingvin QT (CVE-2021-3401)
...
**Pingvin QT users are urged to please update their installations to this
...
leakage of sensitive information when Pingvin Core crashes on Unix platforms.
The vulnerability is patched for systems that run a Linux kernel equal to or
higher than 3.4.

**Pingvin Core wallet users on Linux platforms are urged to please update to
this version.**
...
the Pingvin network, following the reduction of relay and mining defaults in
...
* The user interface for selecting fees when transacting DOGE has been updated
  ...
  Pingvin blocks are not full, typically all transactions are mined in the next
  block, and therefore the target estimation does not makes sense for Pingvin.
...
The Berkley DB version used by Pingvin Core has been updated to 5.3 (from 5.1)
...
performance of cryptographic routines within Pingvin Core.
