# Pingvincoin Core 1.8.1

Pingvincoin Core 1.8.1 is primarily a bugfix release, bringing Pingvincoin Core in
line with Bitcoin 0.9.3. Pingvincoin Core 1.8.1 also adds in support for printing
...
* Disable Transifex based translation process (not used by Pingvincoin Core)
* Add checkpoints around AuxPoW switchover block (371,337)
* Disable connections from pre-1.8 Pingvincoin Core clients
* Use HTTPS with pingchain.info
...
There is a known issue with quantities in JSON used by the RPC interface (https://github.com/pingvincoin/pingvincoin/issues/134).
