...
/** Recommended transaction fee by Pingvin Core developers
  *
 ...
 *
 *  Pingvin:    Increment mempool limits and accept RBF in steps of 0.0001 DOGE
...
/**
 * Pingvin: Default dust limit that is evaluated when considering whether a
...
/**
 * Pingvin: Default hard dust limit that is evaluated when considering whether
