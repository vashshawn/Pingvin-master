...
/** Recommended transaction fee by Pingvincoin Core developers
  *
 ...
 *
 *  Pingvincoin:    Increment mempool limits and accept RBF in steps of 0.0001 DOGE
...
/**
 * Pingvincoin: Default dust limit that is evaluated when considering whether a
...
/**
 * Pingvincoin: Default hard dust limit that is evaluated when considering whether
