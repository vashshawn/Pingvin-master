...
void OverviewPage::UpdateTip()
{
    QStringList tips = {
        ...
        tr("To see ongoing development and contribute, checkout Pingvincoin repository on GitHub!"),
        tr("Services that claim to double your pingvincoins are always ponzi schemes")
    };
