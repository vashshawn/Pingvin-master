...
void OverviewPage::UpdateTip()
{
    QStringList tips = {
        ...
        tr("To see ongoing development and contribute, checkout Pingvin repository on GitHub!"),
        tr("Services that claim to double your pingvins are always ponzi schemes")
    };
