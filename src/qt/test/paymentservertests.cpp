...
void PaymentServerTests::paymentServerTests()
{
    ...
    // Pingvincoin: Disable certificate tests as we don't touch this code, and building test
    ...
    /* PL: This doesn't work for Pingvincoin (as there is no actual maximum coins)
