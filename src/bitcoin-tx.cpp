...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s pingvin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  pingvin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded pingvin transaction") + "\n" +
              "  pingvin-tx [options] -create [commands]   " + _("Create hex-encoded pingvin transaction") + "\n" +
              "\n";
