...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s pingvincoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  pingvincoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded pingvincoin transaction") + "\n" +
              "  pingvincoin-tx [options] -create [commands]   " + _("Create hex-encoded pingvincoin transaction") + "\n" +
              "\n";
