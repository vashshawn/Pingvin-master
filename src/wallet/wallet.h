...
/*
 * Pingvin: Scaled to 1/10th of the recommended transaction fee to make RBF
...
/*
 * Pingvin: Creating change outputs at exactly the dustlimit is counter-
...
public:
    ...
    /**
     * Pingvin: Get a fee targetting a specific transaction speed.
     */
    CAmount GetPingvinPriorityFee(const CMutableTransaction& tx, unsigned int nTxBytes, FeeRatePreset nSpeed);
    /**
     * Pingvin: Get a fee targetting a specific transaction speed.
     */
    static CAmount GetPingvinPriorityFee(const CMutableTransaction& tx, unsigned int nTxBytes, FeeRatePreset nSpeed, CAmount targetFee);
    /**
    ...
    /**
     * Return the minimum required fee taking into account the
     * floating relay fee and user set minimum transaction fee, but not the Pingvin dust fee.
     */
