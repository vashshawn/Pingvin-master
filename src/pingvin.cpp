...
// Pingvin: Normally minimum difficulty blocks can only occur in between
...
unsigned int CalculatePingvinNextWorkRequired(const CBlockIndex* pindexLast, int64_t nFirstBlockTime, const Consensus::Params& params)
{
...
CAmount GetPingvinBlockSubsidy(int nHeight, const Consensus::Params& consensusParams, uint256 prevHash)
{
