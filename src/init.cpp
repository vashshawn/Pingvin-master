...
void Shutdown()
{
    ...
    RenameThread("pingvincoin-shutoff");
    ...
    StopHTTPServer();
#ifdef ENABLE_WALLET
    // Pingvincoin 1.14 TODO: ShutdownRPCMining();
    if (pwalletMain)
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/pingvincoin/pingvincoin>";
    const std::string URL_WEBSITE = "<https://pingvincoin.com>";
...
void ThreadImport(std::vector<boost::filesystem::path> vImportFiles)
{
    ...
    RenameThread("pingvincoin-loadblk");
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("Pingvincoin version %s\n", FormatFullVersion());
}
...
bool AppInitMain(boost::thread_group& threadGroup, CScheduler& scheduler)
{
    ...
    // Pingvincoin: Do we need to do any RPC mining init here?
