...
%if %{_buildqt}
# qt icons
install -D -p share/pixmaps/pingvincoin.ico %{buildroot}%{_datadir}/pixmaps/pingvincoin.ico
install -p share/pixmaps/nsis-header.bmp %{buildroot}%{_datadir}/pixmaps/
install -p share/pixmaps/nsis-wizard.bmp %{buildroot}%{_datadir}/pixmaps/
install -p %{SOURCE100} %{buildroot}%{_datadir}/pixmaps/bitcoin.svg
%{_bindir}/inkscape %{SOURCE100} --export-png=%{buildroot}%{_datadir}/pixmaps/pingvincoin16.png -w16 -h16
%{_bindir}/inkscape %{SOURCE100} --export-png=%{buildroot}%{_datadir}/pixmaps/pingvincoin32.png -w32 -h32
%{_bindir}/inkscape %{SOURCE100} --export-png=%{buildroot}%{_datadir}/pixmaps/pingvincoin64.png -w64 -h64
%{_bindir}/inkscape %{SOURCE100} --export-png=%{buildroot}%{_datadir}/pixmaps/pingvincoin128.png -w128 -h128
%{_bindir}/inkscape %{SOURCE100} --export-png=%{buildroot}%{_datadir}/pixmaps/pingvincoin256.png -w256 -h256
%{_bindir}/convert -resize 16x16 %{buildroot}%{_datadir}/pixmaps/pingvincoin256.png %{buildroot}%{_datadir}/pixmaps/pingvincoin16.xpm
%{_bindir}/convert -resize 32x32 %{buildroot}%{_datadir}/pixmaps/pingvincoin256.png %{buildroot}%{_datadir}/pixmaps/pingvincoin32.xpm
%{_bindir}/convert -resize 64x64 %{buildroot}%{_datadir}/pixmaps/pingvincoin256.png %{buildroot}%{_datadir}/pixmaps/pingvincoin64.xpm
%{_bindir}/convert -resize 128x128 %{buildroot}%{_datadir}/pixmaps/pingvincoin256.png %{buildroot}%{_datadir}/pixmaps/pingvincoin128.xpm
%{_bindir}/convert %{buildroot}%{_datadir}/pixmaps/pingvincoin256.png %{buildroot}%{_datadir}/pixmaps/pingvincoin256.xpm
